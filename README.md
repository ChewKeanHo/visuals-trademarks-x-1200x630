# X|Twitter Trademarks Logo 1200x630 | (Holloway) Chew, Kean Ho's Visuals

[![logo](/Pictures/banner_1200x630.svg)](#)

The X|Twitter Trademarks Logo. They published clear trademark guideline but no
longer supply the required material files for it. The preferred version is
`.svg` which has non-destructive scale up & down properties and can be converted
into any rasterized images (e.g. `jpeg`, `webp`, `avif`, etc). To comply with
our standards, a re-draw is required.

This project re-draws X|Twitter Trademarks Logo specifically for 1200x630 size.
...
```
--------------------------------------------------------------------------------
Title: X|Twitter Trademarks Logo 1200x630
Creators: (Holloway) Chew, Kean Ho
Contact: hello@chewkeanho.com
SKU: chewkeanho-visuals-trademarks-x-1200x630
UUID: D95C4D25-719F-409F-805B-DE07882A8081
License: Creative Commons Attribution-NoDerivatives 4.0 International License
Made On: 2026-02-24
Made From: Malaysia, South East Asia
Procure: https://github.com/chewkeanho/visuals-trademarks-x-1200x630
--------------------------------------------------------------------------------
```
...
> COMPLY WITH X|TWITTER TRADEMARK REQUIREMENTS
> (Refer: https://about.x.com/en/who-we-are/brand-toolkit)**.
>
